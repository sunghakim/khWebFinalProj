...
<head>
    ...
    <link rel="stylesheet" href="/resources/static/css/coupon-list.css">
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    <title>kh final coupon-list management</title>
    <!-- 쿠폰 목록 페이지 -->
</head>
<body>
	<div class="wrapper">
        ...
        <div class="content">
            ...
            <section>
                <div class="article-container">
                    <div class="btns">
                        <button type="submit" class="btn issue">쿠폰 발급</button>
                    </div>
                    <div class="article-wrap">
                        ...
                        <c:forEach var="List" items="${List}">
	                        <ul class="list">
	                            <li>${List.getName()}</li>
	                            <li>${List.getStartDateStr()}</li>
	                           	<li>${List.getEndDateStr()}</li>
	                            <li>${List.getDiscount()}%</li>
    ...
    <script src="/resources/static/js/coupon-list.js"></script>
</body>
</html>