...
--제약조건 조회
SELECT * FROM ALL_CONSTRAINTS WHERE TABLE_NAME = 'REPORT';
SYS_C0018328
--제약조건 수정
ALTER TABLE QUESTION MODIFY RESULT CONSTRAINT RESULT_CHECK CHECK(RESULT = 0 OR RESULT = 1);

--제약조건 삭제
ALTER TABLE SOCIAL_ACCOUNT DROP CONSTRAINT SYS_C0018226;
ALTER TABLE SOCIAL_ACCOUNT DROP CONSTRAINT SYS_C0018224;
...
CREATE TABLE SOCIAL_ACCOUNT(
	...
	, IS_BANNED CHAR(1) CHECK (IS_BANNED = 'T' OR IS_BANNED = 'F')
);
...
CREATE TABLE ITEM_CATEGORY(
	...
	, ITEM_CATEGORY_NAME VARCHAR2(50) NOT NULL
...
DELETE FROM ITEM_OPTION WHERE ITEM_OPTION_ID = '데이터명';
...
CREATE TABLE SOLD_DETAIL(
	...
	, REFUND_STATUS NUMBER CHECK (REFUND_STATUS >= 0 AND REFUND_STATUS <= 6)
...
INSERT INTO BOARD VALUES(1, '커뮤니티 게시판');
---------------------------------------------
CREATE TABLE POST(
...
CREATE TABLE REPORT(
	...
	, REPORT_REASON_ID NUMBER REFERENCES REPORT_REASON(REPORT_REASON_ID) 
	, REPORTER_ID VARCHAR2(50) NOT NULL
	, REPORTED_ACCOUNT_ID VARCHAR(50) NOT NULL
...
CREATE TABLE PUNISH(
	...
	, REPORTED_ACCOUNT_ID VARCHAR2(50) NOT NULL
	, START_DATE DATE DEFAULT (SYSDATE)
	, END_DATE DATE NOT NULL
);
---------------------------------------------
...
INSERT INTO REPORT_REASON(REPORT_REASON_ID, CONTENT) VALUES(1, '부적절한 게시글');
INSERT INTO REPORT_REASON(REPORT_REASON_ID, CONTENT) VALUES(2, '욕설');
SELECT * FROM REPORT_REASON;
---------------------------------------------
CREATE TABLE IMAGE(
	  IMAGE_ID NUMBER PRIMARY KEY
	, REFERENCES_ID NUMBER NOT NULL
	, ID_TYPE VARCHAR2(50) CHECK (ID_TYPE IN ('ITEM', 'REVIEW', 'QUESTION', 'POST', 'REPORT', 'NOTICE'))
	, FILE_NAME VARCHAR2(4000) NOT NULL
	, FILE_URL VARCHAR2(4000) NOT NULL
);
select * from Image;
DELETE FROM IMAGE WHERE REFERENCES_ID = 30;
ALTER TABLE IMAGE MODIFY ID_TYPE VARCHAR2(50) CONSTRAINT IAMGE_ID_TYPE_NN NOT NULL;
