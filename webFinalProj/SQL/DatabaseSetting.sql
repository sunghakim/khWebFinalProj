...
ALTER TABLE ACCOUNT DROP CONSTRAINT SYS_C0018111;
...
CREATE TABLE REPORT(
	...
	, REPORTER VARCHAR2(50) REFERENCES ACCOUNT(ACCOUNT_ID)
	, REPORTED_MEMBER VARCHAR(50) REFERENCES ACCOUNT(ACCOUNT_ID)
	, REPORTED_POST NUMBER REFERENCES POST(POST_ID);
...
---------------------------------------------
CREATE TABLE PUNISH(
	  PUNISH_ID NUMBER PRIMARY KEY
	, REPORT_ID VARCHAR2(50) REFERENCES ACCOUNT(ACCOUNT_ID)
	, TARGET_ID VARCHAR2(50) REFERENCES ACCOUNT(ACCOUNT_ID)
	, START_DATE DATE DEFAULT (SYSDATE)
	, END_DATE DATE NOT NULL
);
CREATE SEQUENCE PUNISH_SEQ NOCACHE
---------------------------------------------
...
--여기에 신고사유 선택해서 그 유형을 리포트에 집어넣는건데
---------------------------------------------
CREATE TABLE IMAGE(
...
ALTER TABLE REPORT MODIFY REPORTER INVISIBLE;
ALTER TABLE REPORT MODIFY REPORTER INVISIBLE;
ALTER TABLE REPORT MODIFY REPORTER INVISIBLE;
ALTER TABLE REPORT MODIFY REPORTER INVISIBLE;
ALTER TABLE REPORT MODIFY REPORTER INVISIBLE;
...
ALTER TABLE REPORT MODIFY REPORTER VISIBLE;