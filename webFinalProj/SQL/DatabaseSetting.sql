...
SELECT ITEM_NAME AS ITEM_NAME, SUM(AMOUNT) AS AMOUNT
FROM (
...
FROM (
	...
	WHERE Z.ORDER_DATE >= TO_DATE(TRUNC(SYSDATE,'dd'), 'yyyy/mm/dd hh24:mi:ss'))
	AND Z.ORDER_DATE <= TO_DATE(TRUNC(SYSDATE,'dd') + 1, 'yyyy/mm/dd hh24:mi:ss'))
	)
GROUP BY NAME;


			WHERE Z.ORDER_DATE <![CDATA[>=]]> TO_DATE(TRUNC(SYSDATE,'dd'), 'yyyy/mm/dd hh24:mi:ss'))
			AND Z.ORDER_DATE <![CDATA[<=]]> TO_DATE(TRUNC(SYSDATE,'dd') + 1, 'yyyy/mm/dd hh24:mi:ss'))